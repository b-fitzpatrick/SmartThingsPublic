/**
 *  Notify of Open Garage Doors When Entering Night Mode
 *
 ...
 */
definition(
    name: "Notify of Open Sensors When Entering Night Mode",
    namespace: "b-fitzpatrick",
    author: "Brian Fitzpatrick",
    description: "Subscribes to the 'Night' mode. When entering 'Night' mode, checks each sensor and sends a notification if it is open.",
    category: "My Apps",
...
def checkSensors(evt) {
    ...
    if (location.currentMode.name == "Night") {
        ...
        if (openSensor == false) {
        	sendPush("Night: Garage Doors are closed.")
        }
    }
}
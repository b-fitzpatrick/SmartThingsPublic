 ...
 *
 *   Modified from device type by KristopherKubicki
 *
...
metadata {
	definition (name: "Yamaha Network Receiver", namespace: "b-fitzpatrick", author: "Brian Fitzpatrick") {
	...
	tiles {
		...
		standardTile("refresh", "device.switch", width: 1, height: 1, canChangeIcon: false, inactiveLabel: true, canChangeBackground: false) {
		...
		main "switch"
        details(["switch","input","mute","level","refresh"])
	}
}
...
def inputNext() { 
    ...
    def selectedInputs = ["AV4","HDMI3","AV4"]
